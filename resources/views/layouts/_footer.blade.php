                        ...
                        <div class="col-lg-4">
                            <div class="footer-block">
                                ...
                                <ul class="social-link">
                                    <li class="twitter">
                                        <a href="{{ url('https://twitter.com/') }}" data-toggle="tooltip"
                                    ...
                                    <li class="google-plus">
                                        <a href="{{ url('https://www.plus.google.com/discover') }}"
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="rating-box pt-20">
                                        <ul class="rating rating-with-review-item">
                                            ...
                                            <li class="no-star"><i class="fa fa-star-o"></i></li>
                                            <li class="review-item"><a href="{{ url('#') }}">Read Review</a>
                                            </li>
                                            <li class="review-item"><a href="{{ url('#') }}">Write Review</a>
                                            </li>
                                        </ul>
                                    </div>
