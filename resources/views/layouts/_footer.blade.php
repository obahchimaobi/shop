                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <ul class="des">
                            ...
                            <li>
                                <span>Phone: </span>
                                <a href="{{ url('#') }}">(+123) 123 321 345</a>
                            </li>
                            <li>
                                <span>Email: </span>
                                <a href="{{ url('mailto://info@yourdomain.com') }}">info@yourdomain.com</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6">
                        <div class="footer-block">
                            ...
                            <ul>
                                <li><a href="{{ url('#') }}">Prices drop</a></li>
                                <li><a href="{{ url('#') }}">New products</a></li>
                                <li><a href="{{ url('#') }}">Best sales</a></li>
                    ...
                    <div class="col-lg-4">
                        <div class="footer-block">
                            ...
                            <ul class="social-link">
                                <li class="twitter">
                                    <a href="{{ url('https://twitter.com/') }}" data-toggle="tooltip" target="_blank"
                                        title="Twitter">
                                        <i class="fa fa-twitter"></i>
                                    </a>
                                </li>
                                <li class="rss">
                                    <a href="{{ url('https://rss.com/') }}" data-toggle="tooltip" target="_blank"
                                        title="RSS">
                                        <i class="fa fa-rss"></i>
                                    </a>
                                </li>
                                <li class="google-plus">
                                    <a href="{{ url('https://www.plus.google.com/discover') }}" data-toggle="tooltip"
                                        target="_blank" title="Google Plus">
                                        <i class="fa fa-google-plus"></i>
                                    </a>
                                </li>
                                <li class="facebook">
                                    <a href="{{ url('https://www.facebook.com/') }}" data-toggle="tooltip"
                                        target="_blank" title="Facebook">
                                        <i class="fa fa-facebook"></i>
                                    </a>
                                </li>
                                <li class="youtube">
                                    <a href="{{ url('https://www.youtube.com/') }}" data-toggle="tooltip"
                                        target="_blank" title="Youtube">
                                        <i class="fa fa-youtube"></i>
                                    </a>
                                </li>
                                <li class="instagram">
                                    <a href="{{ url('https://www.instagram.com/') }}" data-toggle="tooltip"
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-links">
                        <ul>
                            ...
                            <li><a href="{{ url('#') }}">Most Populars</a></li>
                            <li><a href="{{ url('#') }}">New Arrivals</a></li>
                            <li><a href="{{ url('#') }}">Special Products</a></li>
                            <li><a href="{{ url('#') }}">Manufacturers</a></li>
                            <li><a href="{{ url('#') }}">Our Stores</a></li>
                            <li><a href="{{ url('#') }}">Shipping</a></li>
                            <li><a href="{{ url('#') }}">Payments</a></li>
                            <li><a href="{{ url('#') }}">Warantee</a></li>
                            <li><a href="{{ url('#') }}">Refunds</a></li>
                            <li><a href="{{ url('#') }}">Checkout</a></li>
                            <li><a href="{{ url('#') }}">Discount</a></li>
                            <li><a href="{{ url('#') }}">Refunds</a></li>
                            <li><a href="{{ url('#') }}">Policy Shipping</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="copyright text-center pt-25">
                        <span><a target="_blank" href="{{ url('https://www.templateshub.net') }}">Templates
                                Hub</a></span>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <div class="sm-image"><img src="{{ url('images/product/small-size/1.jpg') }}"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ url('images/product/small-size/2.jpg') }}"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ url('images/product/small-size/3.jpg') }}"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ url('images/product/small-size/4.jpg') }}"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ url('images/product/small-size/5.jpg') }}"
                                        alt="product image thumb"></div>
                                <div class="sm-image"><img src="{{ url('images/product/small-size/6.jpg') }}"
                                        alt="product image thumb"></div>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                            ...
                            <div class="product-info">
                                ...
                                <div class="rating-box pt-20">
                                    <ul class="rating rating-with-review-item">
                                        ...
                                        <li class="no-star"><i class="fa fa-star-o"></i></li>
                                        <li class="review-item"><a href="{{ url('#') }}">Read Review</a></li>
                                        <li class="review-item"><a href="{{ url('#') }}">Write Review</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="product-additional-info pt-25">
                                    <a class="wishlist-btn" href="{{ url('wishlist.html') }}"><i
                                            class="fa fa-heart-o"></i>Add to wishlist</a>
                                    <div class="product-social-sharing pt-25">
                                        <ul>
                                            <li class="facebook"><a href="{{ url('#') }}"><i
                                                        class="fa fa-facebook"></i>Facebook</a></li>
                                            <li class="twitter"><a href="{{ url('#') }}"><i
                                                        class="fa fa-twitter"></i>Twitter</a></li>
                                            <li class="google-plus"><a href="{{ url('#') }}"><i
                                                        class="fa fa-google-plus"></i>Google +</a></li>
                                            <li class="instagram"><a href="{{ url('#') }}"><i
