                                        ...
                                        @foreach ($cart as $cartItem)
                                            <tr>
                                                ...
                                                <td class="li-product-thumbnail"><a href="#"><img
                                                            src="{{ asset('storage/' . $cartItem->cart_image) }}" alt="Li's Product Image" style="width: 100px; height: 100px;"></a>
                                                </td>
                                                ...
                                                <td class="quantity">
                                                    ...
                                                    <div class="cart-plus-minus">
                                                        <input class="cart-plus-minus-box" value="{{ $cartItem->item_quantity }}" type="text">
